 ...
 * @author sanda
 */
public class Checkout_Invoice extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Checkout_Invoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Checkout_Invoice().setVisible(true);
            }
        });
    }
