 ...
 * @author sanda
 */
public class Daily_Transaction_Report extends javax.swing.JFrame {

    /**
     * Creates new form Guest_Information_Report
     */
    public Daily_Transaction_Report() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Daily_Transaction_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Daily_Transaction_Report().setVisible(true);
            }
        });
    }
